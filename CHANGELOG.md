...
## [1.34.0](https://github.com/AlfredoCalvimontes/career-ops/compare/career-ops-v1.33.0...career-ops-v1.34.0) (2026-09-23)


### Features

* **apply:** field-type guidance and measured limits for form answers ([d57d69f](https://github.com/AlfredoCalvimontes/career-ops/commit/d57d69f62e696e6d19bab4c53ea626ad02ecb0e6))
* **eval:** pre-scoring eligibility and language gates ([f4d0d76](https://github.com/AlfredoCalvimontes/career-ops/commit/f4d0d76cb0b361463e55da162d12cac8112b46ec))
* **eval:** verify the posting's source host before drafting ([9c9a128](https://github.com/AlfredoCalvimontes/career-ops/commit/9c9a128ea034bef0b5b89d351dbce53c89d7d91b))
* **fetch:** robots.txt gate for browser-header retries ([1959aa0](https://github.com/AlfredoCalvimontes/career-ops/commit/1959aa0bfab7967d99dd1a1aacb8cb849ae561e9))
* **fork:** weekly upstream watch that reports drift and likely conflicts ([7626d64](https://github.com/AlfredoCalvimontes/career-ops/commit/7626d648c15bc2ae13899cc8713d21ca98e291ea))
* **handoff:** export a self-contained prompt for a cheaper AI ([f112413](https://github.com/AlfredoCalvimontes/career-ops/commit/f112413da10d9899bc1c6cf59ccb6c8b7d271138))
* **linkedin:** add mode to audit and rewrite the LinkedIn profile ([4e25e8f](https://github.com/AlfredoCalvimontes/career-ops/commit/4e25e8f4736e0a4c2b565b3d0447ed8ec64c92ec))
* **lint:** lint mode and skill files for dead references ([84b3626](https://github.com/AlfredoCalvimontes/career-ops/commit/84b3626cc85a1fde6c7b4d5679403f2a2c8c1c2a))
* **pdf:** measure the generated PDF's layout, not just its page count ([cc53687](https://github.com/AlfredoCalvimontes/career-ops/commit/cc536870ffac740f968b5ececac076052d5d650a))
* **providers:** add generalist-world board provider ([e85ff79](https://github.com/AlfredoCalvimontes/career-ops/commit/e85ff797ad7a0c3d97fd895072ad81cf44a0330a))
* **providers:** add Python.org Jobs scanner provider ([24557b2](https://github.com/AlfredoCalvimontes/career-ops/commit/24557b2fbc713685b16071068601a61591eab319))
* **providers:** support explicit personio tenant pin ([a639b15](https://github.com/AlfredoCalvimontes/career-ops/commit/a639b15404b042be03e71851dbd2a46ba0856b43))
* **rank:** persistent per-posting state so ranked jobs are never re-scored ([6f565e9](https://github.com/AlfredoCalvimontes/career-ops/commit/6f565e952032f23a50718d5906dc7616ec740216))
* **security:** guards that make supply-chain and personal-data widening loud ([a1ed167](https://github.com/AlfredoCalvimontes/career-ops/commit/a1ed167e8a2853154e02b823bac5d1a759ce835a))
* **strategy:** add strategy mode that ranks role families by tier ([f062a57](https://github.com/AlfredoCalvimontes/career-ops/commit/f062a571fe7de8a4d7c65021d9d3179ab918dcf5))
* **tiers:** rank roles by preference, not only fit (T1/T2/T3 bridge) ([c8dcefc](https://github.com/AlfredoCalvimontes/career-ops/commit/c8dcefc867afb2f281ca8b8fffb435b6d26833ce))
...
* **agents:** stop quoting an injection example that blocks scanner-based hosts ([#4137](https://github.com/AlfredoCalvimontes/career-ops/issues/4137)) ([2f637a2](https://github.com/AlfredoCalvimontes/career-ops/commit/2f637a2a5d2279c96114ffe0826da80784d8f477))
* **analyze-patterns:** an empty tracker is a new user, not a failed command ([727fae3](https://github.com/AlfredoCalvimontes/career-ops/commit/727fae3133f403b520f64ea370fb353fc9ed1c86))
* **audit-portals:** load providers/ from the checkout, not the data root ([#4240](https://github.com/AlfredoCalvimontes/career-ops/issues/4240)) ([88e2d93](https://github.com/AlfredoCalvimontes/career-ops/commit/88e2d93fefc170a180b8c444f0b04b49c3689b6a)), closes [#4171](https://github.com/AlfredoCalvimontes/career-ops/issues/4171)
* **batch:** escape ampersands in offer URLs ([d2cd237](https://github.com/AlfredoCalvimontes/career-ops/commit/d2cd23785a3364ab49d69481ecf8fd04e82f0c0a))
* **batch:** give the worker a Windows-resolvable JD file path under Git Bash ([5d5729e](https://github.com/AlfredoCalvimontes/career-ops/commit/5d5729e4ccee258451c8a004a0084fcb51453d76))
* **batch:** give the worker a Windows-resolvable JD file path under Git Bash ([d4ce630](https://github.com/AlfredoCalvimontes/career-ops/commit/d4ce63022162b515fcc1b99754a0f8b56bd2a475))
* **batch:** parse scores locale-independently in batch-runner ([f24eac2](https://github.com/AlfredoCalvimontes/career-ops/commit/f24eac20c424aaaf11d038f9e00818ce6f6f631d))
* **browser-extract:** normalize JSON-LD length comparison, reset stale title, accept IRI [@type](https://github.com/type) ([27c3325](https://github.com/AlfredoCalvimontes/career-ops/commit/27c3325230a0f677d03755c750a4912ed89d76c4))
* **browser-extract:** read schema.org JobPosting when the DOM has no body ([5fefe46](https://github.com/AlfredoCalvimontes/career-ops/commit/5fefe460eb75084cccc4dac6cef0bdc4f3d5a146))
* **browser-extract:** read schema.org JobPosting when the DOM has no body ([8b5c5be](https://github.com/AlfredoCalvimontes/career-ops/commit/8b5c5bee657c41f63abefd27f89405cb0bc47980))
* **ci:** check out base before running labeler ([eaf10ad](https://github.com/AlfredoCalvimontes/career-ops/commit/eaf10adb3b34c79554f5b422c8bc9b9c5eaf23ac))
* **clean-markers:** add -h/--help and reject unrecognized flags ([43f8dfb](https://github.com/AlfredoCalvimontes/career-ops/commit/43f8dfb003a5b103dd5e21268d0efc8d92c0fdd7))
* **cv-latex:** keep %, #, ~ and & in CV links, escaped for hyperref ([#4288](https://github.com/AlfredoCalvimontes/career-ops/issues/4288)) ([8790f97](https://github.com/AlfredoCalvimontes/career-ops/commit/8790f97ae8df254715222a4e617aa8bb5de9a724))
* **dashboard:** neutralize control characters in the help-bar flash ([ff2945c](https://github.com/AlfredoCalvimontes/career-ops/commit/ff2945c98dea92754b7d270bf03aea0bc53c6ac3))
* **dashboard:** stats panels overflow their column, and "evaluated" labels three different numbers ([#4075](https://github.com/AlfredoCalvimontes/career-ops/issues/4075)) ([e150d3a](https://github.com/AlfredoCalvimontes/career-ops/commit/e150d3a21c6b066115cbc5a63ca1e9602959346e))
* **dashboard:** surface open failures in the UI instead of stderr ([6ac8531](https://github.com/AlfredoCalvimontes/career-ops/commit/6ac8531a9013f04ad6c29170d9eef2cdd119eb13))
* **discover-ats:** SmartRecruiters' phantom empty board no longer outranks a real not-found ([cd72ef8](https://github.com/AlfredoCalvimontes/career-ops/commit/cd72ef83d1ef654b33eab7a1e278932b56fd686e))
* **doctor:** pin git locale so the not-a-checkout skip works in any language ([2a73233](https://github.com/AlfredoCalvimontes/career-ops/commit/2a73233e135064271e97b935ec703289d21f71a9))
* **gitignore:** cover reports/ subdirectories, not just the top level ([#4174](https://github.com/AlfredoCalvimontes/career-ops/issues/4174)) ([54c57ef](https://github.com/AlfredoCalvimontes/career-ops/commit/54c57ef9590ee8c60b0661140ded286f7fd2e0f7))
* **icims:** stop doubling the careers- prefix on iCIMS board hosts ([444fedd](https://github.com/AlfredoCalvimontes/career-ops/commit/444fedd9932581cc8844795118ad10d980b247ca))
* improve error message for missing cv.md ([602ac8b](https://github.com/AlfredoCalvimontes/career-ops/commit/602ac8b635ecf48b5c9068214666fa0c5c283ba2))
* **jd-skill-gap:** improve error message for missing cv.md ([f783f0a](https://github.com/AlfredoCalvimontes/career-ops/commit/f783f0a64e1cf6b57db43dc36af762ec476b9e13))
* **jd-skill-gap:** recognize bolded and uncontracted requirements headings ([#4285](https://github.com/AlfredoCalvimontes/career-ops/issues/4285)) ([d459180](https://github.com/AlfredoCalvimontes/career-ops/commit/d4591808f0ea2b05282980be0b2afa071e54fd35))
* **liveness:** move bare "Job Expired" banner to a soft tier + guard closed-loop compounds ([5358534](https://github.com/AlfredoCalvimontes/career-ops/commit/535853476587795fdb0a14ec7691e3b3dcf85a45))
* **liveness:** recognize "role/position is closed" and bare "Job Expired" banners ([cb41016](https://github.com/AlfredoCalvimontes/career-ops/commit/cb4101614fa7701539a8faa0e1955710cccc3268))
* **pipeline:** route CV output on cv.output_format instead of the PDF score gate ([#3944](https://github.com/AlfredoCalvimontes/career-ops/issues/3944)) ([1d4993d](https://github.com/AlfredoCalvimontes/career-ops/commit/1d4993dc1b7b1eb472455609a5e0425c7006ae34))
* **providers:** avature preserves facet filters across pages, flags broken parses ([#4252](https://github.com/AlfredoCalvimontes/career-ops/issues/4252)) ([0674308](https://github.com/AlfredoCalvimontes/career-ops/commit/0674308f55f240427386003466fa946066f6ab9c))
* **providers:** build SEEK job links per market host + opt-in appendWorkType ([#3436](https://github.com/AlfredoCalvimontes/career-ops/issues/3436)) ([8f345f3](https://github.com/AlfredoCalvimontes/career-ops/commit/8f345f38002bc58670208568fd9e4641c63f616b))
* **providers:** give the Lever board feed a 30s timeout, not the 10s default ([#4284](https://github.com/AlfredoCalvimontes/career-ops/issues/4284)) ([70f5a0a](https://github.com/AlfredoCalvimontes/career-ops/commit/70f5a0abf031f70eb4102e395731fdcebd875df5)), closes [#4177](https://github.com/AlfredoCalvimontes/career-ops/issues/4177)
* **providers:** match inner class tokens and fail loud on unusable generalist-world cards ([#4264](https://github.com/AlfredoCalvimontes/career-ops/issues/4264)) ([4ef31bd](https://github.com/AlfredoCalvimontes/career-ops/commit/4ef31bdbb2c825eb6d55d4fa47a428d1f7cad894))
* **providers:** oraclecloud drops 12% of a board on a short middle page ([98380e7](https://github.com/AlfredoCalvimontes/career-ops/commit/98380e74b4baf59619a33ccf0b16ccfa640ffddb))
* **providers:** oraclecloud drops 12% of a board on a short middle page ([78d21e2](https://github.com/AlfredoCalvimontes/career-ops/commit/78d21e2d18a4963dafe063e5f301d687a1519c55))
* **providers:** pass redirect:'error' on deutschebahn requests ([74d7ab2](https://github.com/AlfredoCalvimontes/career-ops/commit/74d7ab2174323bdc6fae4145427efa7d6c0cbd73))
* **providers:** retry transient aborts in deutschebahn and manfred ([54b9bbb](https://github.com/AlfredoCalvimontes/career-ops/commit/54b9bbb33f877f3652e792f81962464a521d451e))
* **providers:** retry transient aborts in deutschebahn and manfred ([b4e9aa7](https://github.com/AlfredoCalvimontes/career-ops/commit/b4e9aa7a810c71186b08e9e35d5d7ceb01d13ae4))
* **role-matcher:** split one-sided level with two-sided vocabulary gap ([#4058](https://github.com/AlfredoCalvimontes/career-ops/issues/4058)) ([1cd3633](https://github.com/AlfredoCalvimontes/career-ops/commit/1cd36333f4dd33e3bda5347bd03217d3a0172c89))
* **scaffolder:** do not report "ready" when npm install failed ([ca94dcc](https://github.com/AlfredoCalvimontes/career-ops/commit/ca94dccbc274a75cf16b8d0a65bf3e5501768171))
* **scaffolder:** do not report "ready" when npm install failed ([1b1cdcd](https://github.com/AlfredoCalvimontes/career-ops/commit/1b1cdcd65bc9cbd9068e950401712568da14a965))
* **scan:** recheck_after_days frees a row, then pipeline.md pins it again ([#3958](https://github.com/AlfredoCalvimontes/career-ops/issues/3958)) ([8ef3a4e](https://github.com/AlfredoCalvimontes/career-ops/commit/8ef3a4e7beef12092aa99e375c70a50e8cf3e968))
* **set-status:** add --help/-h and list the canonical states in usage ([#4066](https://github.com/AlfredoCalvimontes/career-ops/issues/4066)) ([8c47fbc](https://github.com/AlfredoCalvimontes/career-ops/commit/8c47fbcc6c8175530b662dfde25d65fad7d78953))
* **templates:** honor profile styles in Chinese Minimal CVs ([#4112](https://github.com/AlfredoCalvimontes/career-ops/issues/4112)) ([efd4a8b](https://github.com/AlfredoCalvimontes/career-ops/commit/efd4a8b4081f09073becda38753c3cb2ebd05f4d))
* **test-all:** stop flagging 7 files that legitimately credit the maintainer ([#4144](https://github.com/AlfredoCalvimontes/career-ops/issues/4144)) ([a6c4057](https://github.com/AlfredoCalvimontes/career-ops/commit/a6c405747038343dce0bce3124fa1b6ab5c22fbc))
* **tests:** skip web-argv static half when web/ is not installed ([946b741](https://github.com/AlfredoCalvimontes/career-ops/commit/946b74180be0826eda3cca1b6667cf3261bc2a1e))
* **tests:** support core-only argv contract checks ([66eb559](https://github.com/AlfredoCalvimontes/career-ops/commit/66eb5592e887a2f95b984d9f895f75fd6db2f58a))
* **update-system:** keep an upstream negation ahead of newly appended rules ([#4142](https://github.com/AlfredoCalvimontes/career-ops/issues/4142)) ([749950a](https://github.com/AlfredoCalvimontes/career-ops/commit/749950a8757200f1617671260ef8009d0a4c4f0e))
* **verifiers:** resolve provider plugins like the scanner ([#4026](https://github.com/AlfredoCalvimontes/career-ops/issues/4026)) ([#4046](https://github.com/AlfredoCalvimontes/career-ops/issues/4046)) ([c8e595a](https://github.com/AlfredoCalvimontes/career-ops/commit/c8e595aead66411db8542c4e9ec785406baffeed))
* **verify-ats:** stop the shipped template's own CSS from docking 15 points ([#4270](https://github.com/AlfredoCalvimontes/career-ops/issues/4270)) ([eb9d5f1](https://github.com/AlfredoCalvimontes/career-ops/commit/eb9d5f161cb6676262be50528c6f7071638d1b85))
* **verify-ats:** trim CSS whitespace, so U+00A0 cannot hide a font name ([#4283](https://github.com/AlfredoCalvimontes/career-ops/issues/4283)) ([c9e00e6](https://github.com/AlfredoCalvimontes/career-ops/commit/c9e00e6c2d20289c8f87ef576b24670f24e54374))
* **verify-cv-facts:** also strip single-asterisk italic emphasis ([97932d0](https://github.com/AlfredoCalvimontes/career-ops/commit/97932d01c4331d4bf3cac059ad53ee8a92a46336))
* **verify-cv-facts:** consolidate markdown emphasis stripping (**, __, *) ([da5cc25](https://github.com/AlfredoCalvimontes/career-ops/commit/da5cc257279068b13c4d70de088dce08c588dd14))
* **verify-cv-facts:** recognize bolded metrics in stripMarkup ([f1ae257](https://github.com/AlfredoCalvimontes/career-ops/commit/f1ae2576ef57f5e822121b67a526acb9e0283a07))
* **verify-cv-facts:** revert boundary-guarded italic regex, it broke the LaTeX star-command test ([10cfbd2](https://github.com/AlfredoCalvimontes/career-ops/commit/10cfbd2ba3f59452d25321ea7a4fe890eeaf28de))
* **verify-cv-facts:** the fabrication gate read neither its sources nor its config from the data root ([#4208](https://github.com/AlfredoCalvimontes/career-ops/issues/4208)) ([dd18eb5](https://github.com/AlfredoCalvimontes/career-ops/commit/dd18eb5e516ea6e41e3733529795a3470b95c637))
* **verify-portals:** --help no longer falls through to the full network sweep ([#4254](https://github.com/AlfredoCalvimontes/career-ops/issues/4254)) ([e2baa19](https://github.com/AlfredoCalvimontes/career-ops/commit/e2baa1911da58ac014be23c755d4aaf321e771f9))
* **verify-portals:** reject a missing or swallowed --file operand ([#4280](https://github.com/AlfredoCalvimontes/career-ops/issues/4280)) ([bd4dc0d](https://github.com/AlfredoCalvimontes/career-ops/commit/bd4dc0da74fbb976a30e70a82b6cb9f286c8b702))
...
* **workday:** resolve "N Locations" placeholders from the detail endpoint ([4e5a812](https://github.com/AlfredoCalvimontes/career-ops/commit/4e5a8123cc015b6af7372d4459c6927d183c4d27))
